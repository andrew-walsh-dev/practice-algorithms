...
function greatestProduct(arr, index, rowLength) {
  ...
  if (arr[index + 3] != undefined) {
    rightProduct = arr[index] * arr[index + 1] * arr[index + 2] * arr[index + 3];
  }
  if (arr[index - (3 * rowLength) + 3] != undefined) {
    uprightProduct = arr[index] * arr[index - rowLength + 1] * arr[index - (2 * rowLength) + 2] * arr[index - (3 * rowLength) + 3];
  }
